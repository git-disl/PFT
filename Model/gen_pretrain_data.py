...
def main():
    ...
    if FLAGS.do_embed:
        ...
        output_filename = FLAGS.data_dir + FLAGS.dataset_name + ".embed.tfrecord"
    ...
    if FLAGS.do_eval:  # select 20% for testing
        ...
        eval_output_filename = FLAGS.data_dir + FLAGS.dataset_name + ".test.tfrecord"
    ...
    output_filename = FLAGS.data_dir + FLAGS.dataset_name + ".train.tfrecord"
