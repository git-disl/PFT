...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        self_embedding_file_name = "./data/self_embedding_" + FLAGS.algo + ".npy"
        deself_embedding_file_name = "./data/delself_embedding_" + FLAGS.algo + ".npy"
...
if __name__ == '__main__':
    ...
    del_flags(FLAGS, ["do_train", "do_eval", "test_input_file", "neg_sample_num", "init_checkpoint", "bert_config_file", "data_dir", "algo"])
    ...
    flags.DEFINE_string("algo", None, "algorithm (BERT or PPLM)")
    flags.DEFINE_string(
