...
def load_data(f_in, f_out):
    ...
    while True:
        ...
        from_address = record[3]
        to_address = record[4]
        value = int(record[5]) / (pow(10, 12))
        gas = int(record[6])
        gas_price = int(record[7])
        block_timestamp = int(record[8])
...
def main():
    ...
    f_in = open("/home/sihao/CLR4ETH/Data/sampled_2hop_transaction_in.csv", "r")
    f_out = open("/home/sihao/CLR4ETH/Data/sampled_2hop_transaction_out.csv", "r")
